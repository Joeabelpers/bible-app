...
/* BOTTOM TAB BAR — fixed at bottom */
  ...
  .floating-title { position:sticky; top:0; z-index:20; text-align:center; padding:8px 16px 20px; pointer-events:none; background:linear-gradient(to bottom, var(--parchment) 50%, transparent 100%); }
  .dark .floating-title { background:linear-gradient(to bottom, var(--ink) 50%, transparent 100%); }
